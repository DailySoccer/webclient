  ...
  <div class="profile-content">
    ...
    <div class="personal-data">
      <div class="data-header">
        ...
        <div class="button-wrapper"><button class="action-button" ng-click="editPersonalData()">{{getLocalizedText("buttonedit")}}</button></div>
    ...
    <div class="pocket-data">
      <div class="data-header">
          ...
          <div class="button-wrapper">
            <button class="action-button-transaction" ng-click="goTransactions()">{{getLocalizedText("transactions")}}</button>
            <button class="action-button-get-funds" ng-click="goWithdrawFounds()">{{getLocalizedText("withdrawfunds")}}</button>
          </div>
       </div>
      <div class="data-container-9">
        <div class="data-row"><span class="data-key">{{getLocalizedText("actualbalance")}}:</span><span class="data-value-balance">{{userData.balance}}</span></div>
        <div class="data-row"><span class="data-key">{{getLocalizedText("pendingbonus")}}:</span><span class="data-value">{{userData.bonus}}</span></div-->
      </div>
      <div class="data-container-3">
        <button class="add-funds-button" ng-click="goAddFounds()">{{getLocalizedText("addfunds")}}</button>
      </div>
    </div>

    <div class="epicpoints-data">
      <div class="data-header"><span class="data-header-title">{{getLocalizedText("epicpoints")}}</span></div>
      <div class="data-row">
        <div class="data-column"><span class="data-key">{{getLocalizedText("e11pbalance")}}:</span><span class="data-value">--€</span></div>
        <div class="data-column"><span class="data-key">&lt;{{getLocalizedText("uitimonth")}}&gt;:</span><span class="data-value">--€</span></div>
      </div>
      <div class="data-row">
        <div class="data-column"><span class="data-key">{{getLocalizedText("thismonth")}}:</span><span class="data-value">--€</span></div>
        <div class="data-column"><span class="data-key">&lt;{{getLocalizedText("penulmonth")}}&gt;:</span><span class="data-value">--€</span></div>
        <div class="data-column"><a class="data-link" href="">{{getLocalizedText("howtouse")}}</a></div>
      </div>
    </div>
  </div>
...
tc.put("packages/webclient/components/contests_list_comp.html", new HttpResponse(200, r"""<div class="contests-list-root">
  <div class="contest-row" ng-repeat="contest in currentPageList">
    ...
    <div class="column-contest-price" ng-click="onRow(contest)" ng-if="!contest.isLive && !contest.isHistory">
      ...
      <div class="column-contest-price-header">{{getLocalizedText("entryfee")}}</div>
      <!-- torneo gratis -->
    ...
    <div class="column-contest-position" ng-click="onRow(contest)" ng-if="contest.isLive || contest.isHistory">
      ...
      <div class="column-contest-position-header">{{getLocalizedText("of")}} {{contest.maxEntries}}</div>
    </div>
    ...
    <div class="column-contest-prize" ng-click="onRow(contest)" ng-if="!contest.isLive">
      ...
      <div class="column-contest-prize-header">{{getLocalizedText("prize")}}</div>
    </div>
    ...
    <div class="column-contest-points" ng-click="onRow(contest)" ng-if="contest.isLive">
      ...
      <div class="column-contest-points-header">{{getLocalizedText("points")}}</div>
    </div>
