...
import 'package:webclient/components/navigation/deprecated_version_screen_comp.dart' as import_69;
import 'package:webclient/components/contests_list_f2p_comp.dart' as import_70;
import 'package:webclient/utils/max_text_width.dart' as import_71;
import 'package:webclient/components/enter_contest/lineup_selector_comp.dart' as import_72;
import 'package:webclient/components/social/social_share_comp.dart' as import_73;
import 'package:webclient/components/scouting/scouting_comp.dart' as import_74;
import 'package:webclient/components/scoring_rules_comp.dart' as import_75;
import 'package:webclient/services/scoring_rules_service.dart' as import_76;
import 'package:webclient/components/achievement_list_comp.dart' as import_77;
import 'package:webclient/components/legalese_and_help/rules_comp.dart' as import_78;
import 'package:webclient/components/legalese_and_help/how_it_works_comp.dart' as import_79;
import 'package:webclient/components/leaderboard_comp.dart' as import_80;
import 'package:webclient/utils/limit_to_dot.dart' as import_81;
import 'package:webclient/components/flash_messages_comp.dart' as import_82;
import 'package:webclient/components/enter_contest/soccer_players_filter_comp.dart' as import_83;
import 'package:webclient/components/leaderboard_table_comp.dart' as import_84;
import 'package:webclient/utils/ng_bind_html_unsafe.dart' as import_85;
import 'package:webclient/components/account/user_profile_comp.dart' as import_86;
import 'package:webclient/components/account/login_comp.dart' as import_87;
import 'package:webclient/components/create_contest_comp.dart' as import_88;
import 'package:webclient/components/contest_info_comp.dart' as import_89;
import 'package:webclient/components/scouting/scouting_league_comp.dart' as import_90;
import 'package:webclient/components/view_contest/teams_panel_comp.dart' as import_91;
...
final Key _KEY_ScoringRulesService = new Key(import_76.ScoringRulesService);
...
final Map<Type, Function> typeFactories = <Type, Function>{
  ...
  import_69.DeprecatedVersionScreenComp: () => new import_69.DeprecatedVersionScreenComp(),
  import_70.ContestsListF2PComp: (a1, a2) => new import_70.ContestsListF2PComp(a1, a2),
  import_71.MaxTextWidthDirective: (a1) => new import_71.MaxTextWidthDirective(a1),
  import_72.LineupSelectorComp: () => new import_72.LineupSelectorComp(),
  import_73.SocialShareComp: () => new import_73.SocialShareComp(),
  import_74.ScoutingComp: (a1, a2, a3, a4, a5) => new import_74.ScoutingComp(a1, a2, a3, a4, a5),
  import_75.ScoringRulesComp: (a1, a2) => new import_75.ScoringRulesComp(a1, a2),
  import_76.ScoringRulesService: (a1) => new import_76.ScoringRulesService(a1),
  import_77.AchievementListComp: (a1) => new import_77.AchievementListComp(a1),
  import_78.RulesComp: () => new import_78.RulesComp(),
  import_79.HowItWoksComp: (a1) => new import_79.HowItWoksComp(a1),
  import_80.LeaderboardComp: (a1, a2, a3, a4, a5, a6) => new import_80.LeaderboardComp(a1, a2, a3, a4, a5, a6),
  import_81.LimitToDot: () => new import_81.LimitToDot(),
  import_82.FlashMessageComp: (a1, a2, a3) => new import_82.FlashMessageComp(a1, a2, a3),
  import_83.SoccerPlayersFilterComp: (a1) => new import_83.SoccerPlayersFilterComp(a1),
  import_84.LeaderboardTableComp: () => new import_84.LeaderboardTableComp(),
  import_85.NgBindHtmlUnsafeDirective: (a1) => new import_85.NgBindHtmlUnsafeDirective(a1),
  import_86.UserProfileComp: (a1, a2, a3, a4) => new import_86.UserProfileComp(a1, a2, a3, a4),
  import_87.LoginComp: (a1, a2, a3, a4, a5) => new import_87.LoginComp(a1, a2, a3, a4, a5),
  import_88.CreateContestComp: (a1, a2) => new import_88.CreateContestComp(a1, a2),
  import_89.ContestInfoComp: (a1, a2, a3, a4, a5, a6, a7) => new import_89.ContestInfoComp(a1, a2, a3, a4, a5, a6, a7),
  import_90.ScoutingLeagueComp: (a1, a2) => new import_90.ScoutingLeagueComp(a1, a2),
  import_91.TeamsPanelComp: (a1, a2, a3) => new import_91.TeamsPanelComp(a1, a2, a3),
  ...
  import_102.FooterComp: (a1, a2, a3, a4, a5, a6, a7, a8) => new import_102.FooterComp(a1, a2, a3, a4, a5, a6, a7, a8),
...
final Map<Type, List<Key>> parameterKeys = {
  ...
  import_69.DeprecatedVersionScreenComp: const[],
  import_70.ContestsListF2PComp: [_KEY_ScreenDetectorService, _KEY_ProfileService],
  import_71.MaxTextWidthDirective: [_KEY_Element],
  import_72.LineupSelectorComp: const[],
  import_73.SocialShareComp: const[],
  import_74.ScoutingComp: [_KEY_RouteProvider, _KEY_Router, _KEY_LoadingService, _KEY_ProfileService, _KEY_SoccerPlayerService],
  import_75.ScoringRulesComp: [_KEY_ScoringRulesService, _KEY_FlashMessagesService],
  import_76.ScoringRulesService: [_KEY_ServerService],
  import_77.AchievementListComp: [_KEY_ProfileService],
  import_78.RulesComp: const[],
  import_79.HowItWoksComp: [_KEY_ScreenDetectorService],
  import_80.LeaderboardComp: [_KEY_LeaderboardService, _KEY_LoadingService, _KEY_ProfileService, _KEY_Router, _KEY_RouteProvider, _KEY_Element],
  import_81.LimitToDot: const[],
  import_82.FlashMessageComp: [_KEY_FlashMessagesService, _KEY_ServerService, _KEY_Element],
  import_83.SoccerPlayersFilterComp: [_KEY_ScreenDetectorService],
  import_84.LeaderboardTableComp: const[],
  import_85.NgBindHtmlUnsafeDirective: [_KEY_Element],
  import_86.UserProfileComp: [_KEY_Router, _KEY_ProfileService, _KEY_LoadingService, _KEY_LeaderboardService],
  import_87.LoginComp: [_KEY_Router, _KEY_ProfileService, _KEY_LoadingService, _KEY_Element, _KEY_ScreenDetectorService],
  import_88.CreateContestComp: [_KEY_Router, _KEY_ContestsService],
  import_89.ContestInfoComp: [_KEY_ScreenDetectorService, _KEY_RouteProvider, _KEY_LoadingService, _KEY_Router, _KEY_ContestsService, _KEY_ProfileService, _KEY_FlashMessagesService],
  import_90.ScoutingLeagueComp: [_KEY_RouteProvider, _KEY_Router],
  import_91.TeamsPanelComp: [_KEY_ScreenDetectorService, _KEY_ContestsService, _KEY_RouteProvider],
  ...
  import_102.FooterComp: [_KEY_Router, _KEY_LoadingService, _KEY_View, _KEY_Element, _KEY_DateTimeService, _KEY_ScreenDetectorService, _KEY_ProfileService, _KEY_TemplateService],
