        ...
        <div class="tab-pane active" id="lineup-tab-content">
            ...
            <div class="enter-contest-lineup-wrapper">
              <div class="enter-contest-lineup">
                ...
                <lineup-selector ng-show="!isSelectingSoccerPlayer || scrDet.isNotXsScreen" has-max-players-same-team="playersInSameTeamValid" has-negative-balance="isNegativeBalance"></lineup-selector>
              </div>
            </div>
...
tc.put("packages/webclient/components/enter_contest/lineup_selector_comp.html", new HttpResponse(200, r"""<div class="lineup-selector">
  ...
  <div class="alert alert-danger alert-max-players-same-team" ng-class="{'active':!alertMaxPlayersSameTeam}" role="alert">
