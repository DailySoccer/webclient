...
import 'package:webclient/components/social/friends_bar_comp.dart' as import_97;
import 'package:webclient/components/legalese_and_help/help_info_comp.dart' as import_98;
import 'package:webclient/utils/noshim.dart' as import_99;
import 'package:webclient/components/account/remember_password_comp.dart' as import_100;
import 'package:webclient/components/navigation/footer_comp.dart' as import_101;
import 'package:webclient/components/simple_promo_f2p_comp.dart' as import_102;
import 'package:webclient/components/social/twitter_share_comp.dart' as import_103;
import 'package:webclient/components/view_contest/fantasy_team_comp.dart' as import_104;
import 'package:webclient/components/view_contest/users_list_comp.dart' as import_105;
import 'package:webclient/components/enter_contest/soccer_players_list_comp.dart' as import_106;
import 'package:webclient/components/account/payment_response_comp.dart' as import_107;
import 'package:webclient/components/view_contest/view_contest_entry_comp.dart' as import_108;
import 'package:webclient/utils/translate_decorator.dart' as import_109;
import 'package:webclient/components/tutorial_list_comp.dart' as import_110;
...
final Map<Type, Function> typeFactories = <Type, Function>{
  ...
  import_97.FriendsBarComp: () => new import_97.FriendsBarComp(),
  import_98.HelpInfoComp: (a1, a2) => new import_98.HelpInfoComp(a1, a2),
  ...
  import_105.UsersListComp: (a1, a2) => new import_105.UsersListComp(a1, a2),
  import_106.SoccerPlayersListComp: (a1, a2, a3, a4) => new import_106.SoccerPlayersListComp(a1, a2, a3, a4),
  import_107.PaymentResponseComp: (a1, a2, a3) => new import_107.PaymentResponseComp(a1, a2, a3),
  import_108.ViewContestEntryComp: (a1, a2, a3, a4, a5, a6, a7) => new import_108.ViewContestEntryComp(a1, a2, a3, a4, a5, a6, a7),
  import_109.TranslateDecorator: (a1) => new import_109.TranslateDecorator(a1),
  import_110.TutorialListComp: (a1) => new import_110.TutorialListComp(a1),
...
final Map<Type, List<Key>> parameterKeys = {
  ...
  import_97.FriendsBarComp: const[],
  import_98.HelpInfoComp: [_KEY_ScreenDetectorService, _KEY_Router],
  ...
  import_105.UsersListComp: [_KEY_RouteProvider, _KEY_ProfileService],
  import_106.SoccerPlayersListComp: [_KEY_ScreenDetectorService, _KEY_Element, _KEY_VmTurnZone, _KEY_ProfileService],
  import_107.PaymentResponseComp: [_KEY_RouteProvider, _KEY_Router, _KEY_PaymentService],
  import_108.ViewContestEntryComp: [_KEY_RouteProvider, _KEY_ScreenDetectorService, _KEY_ContestsService, _KEY_ProfileService, _KEY_Router, _KEY_LoadingService, _KEY_TutorialService],
  import_109.TranslateDecorator: [_KEY_Element],
  import_110.TutorialListComp: [_KEY_Router],
