...
tc.put("packages/webclient/components/account/edit_personal_data_comp.html", new HttpResponse(200, r"""<form id="editPersonalDataForm" class="edit-form" ng-submit="saveChanges()" role="form" autocomplete="off" ng-show="!loadingService.isLoading">
  <div class="content">
    ...
    <div class="content-field">
      ...
      <input id="txtNickName" class="text-input name" type="text" maxlength="{{MAX_NICKNAME_LENGTH}}" ng-model="editedNickName" placeholder="{{getLocalizedText('username')}}" class="form-control" tabindex="3" autocapitalize="off">
      <!-- Error de nickName -->
...
<div class="notification-clear-section" ng-if="notificationList.length > 0" ng-click="cleanNotifications()"><span>BORRAR TODAS</span><i class="material-icons">&#xE0B8;</i></div>"""));
...
<div class="personal-data profile-section">
  <div class="profile-data-content">
    ...
    <div class="profile-data-row">
      ...
      <span class="profile-data-value name">{{userData.nickName}}</span>
    </div>
...
tc.put("packages/webclient/components/contest_info_comp.html", new HttpResponse(200, r"""<div id="contestInfoTabbed" ng-show="contest != null">
  ...
  <div class="matches-involved">
      <div class="match" ng-repeat="match in currentInfoData['matchesInvolved']">
          ...
          <div class="date" ng-if="match.isStarted" ng-bind-html-unsafe="getMatchEvent(match)"></div>
  ...
  <div class="contestant-list">
    ...
    <div class="contestant-element"ng-repeat="contestant in currentInfoData['contestants']" ng-class="{'highlight': contestant.name == userName}">
...
<!-- SOCCER PLAYER LIST -->
<section class="soccer-player-list-section" ng-if="isSelectingSoccerPlayerInitialized" ng-show="isSelectingSoccerPlayerActive">
...
<!-- SOCCER PLAYER STATS -->
<section class="soccer-player-list-section" ng-if="isSoccerPlayerStatsInitialized" ng-show="isSoccerPlayerStatsActive">
...
<!-- CONTEST INFO -->
<section class="contest-info-section" ng-if="isContestInfoInitialized" ng-show="isContestInfoActive">
...
<modal-window class="error-joining-modal small" show-header="false" show-window="joiningErrorText != ''">
  ...
  <div class="error-joining-text">{{joiningErrorText}}</div>
...
tc.put("packages/webclient/components/enter_contest/lineup_field_selector_comp.html", new HttpResponse(200, r"""<div class="lineup-field-selector" ng-class="getLineupClassname()">
  ...
  <div class="lineup-selector-wrapper" ng-class="{'changing-mode': highlightChangeables, 'is-live': isLive}">
...
<div class="soccer-player-stats-content">
  ...
  <div class="soccer-player-stats-tab-pane" id="season-stats-tab-content" ng-class="{'active': isSeasonStatsActive}" ng-if="isSeasonStatsInitialized">
  ...
  <div class="soccer-player-stats-tab-pane" id="match-by-match-stats-tab-content" ng-class="{'active': isMatchByMatchStatsActive}" ng-if="isMatchByMatchStatsInitialized">
...
tc.put("packages/webclient/components/enter_contest/soccer_players_scalinglist_comp.html", new HttpResponse(200, r"""<div class="soccer-player-table-header">
  <div class="column-header"   ><i class="material-icons">&#xE164;</i></div>
  <div class="column-header column-tshirt" ></div>
  <div class="column-header column-primary-info column-info"   ng-click="sortListByField('Name')">{{getLocalizedText('name')}}</div>
  <div class="column-header column-dfp column-info"    ng-click="sortListByField('DFP')">{{getLocalizedText('dfp')}}</div>
  <div class="column-header column-salary column-info" ng-click="sortListByField('Salary')">{{getLocalizedText('salary')}}</div>
...
<div class="soccer-player-table-body">
  <div ng-id="'soccerPlayer' + soccerPlayer.id" ng-repeat="soccerPlayer in currentSoccerPlayerList.elements track by soccerPlayer.id" class="soccer-players-list-slot" ng-class="[POS_CLASS_NAMES[soccerPlayer.fieldPos.abrevName], !soccerPlayerIsAvailable(soccerPlayer) ? 'not-available': '', isAddAction(soccerPlayer) ? 'soccer-player-add':'soccer-player-remove']">
    ...
    <!-- Nombre jugador -->
    <div class="column-data column-primary-info" ng-click="onActionClick({'soccerPlayer': soccerPlayer})">
    ...
    <!-- Puntos -->
    <div class="column-data column-dfp" ng-click="onActionClick({'soccerPlayer': soccerPlayer})">{{soccerPlayer.printableFantasyPoints}}</div>
    
    <!-- Salario -->
    <div class="column-data column-salary" ng-click="onActionClick({'soccerPlayer': soccerPlayer})">{{parseSalary(soccerPlayer)}}</div>
    
    <!-- boton añadir a alineación -->
...
<leaderboard-table  share-info="sharingInfoTrueSkill" show-header="true" ranking-type="'TRUESKILL'" highlight-element="playerPointsInfo" 
...
<leaderboard-table  share-info="sharingInfoGold" show-header="true" ranking-type="'GOLD'" highlight-element="playerMoneyInfo" 
...
tc.put("packages/webclient/components/leaderboards/ranking_comp.html", new HttpResponse(200, r"""<div class="ranking-wrapper">
  ...
  <div class="user-data user-points-data">
    <div class="user-position">{{myPointsData.skillRank}}º</div>
    <div class="user-name">{{profileService.user.nickName}}</div>
    <div class="user-points">{{myPointsData.trueSkill}}</div>
  </div>
  <leaderboard-table minimized show-header="false" table-elements="pointsUserList" ranking-type="'TRUESKILL'" rows="3"></leaderboard-table>
...
<div class="ranking-wrapper">
  ...
  <div class="user-data user-money-data">
    <div class="user-position">{{myMoneyData.goldRank}}º</div>
    <div class="user-name">{{profileService.user.nickName}}</div>
    <div class="user-points">{{myMoneyData.earnedMoney}}</div>
  </div>
  <leaderboard-table minimized show-header="false" table-elements="moneyUserList" ranking-type="'GOLD'" rows="3"></leaderboard-table>
...
<section class="contest-list-wrapper">
    ...
    <div class="no-contests-wrapper" ng-show="isContestListEmpty">
      ...
      <div class="no-contests-title">Te has apuntado a todos los torneos disponibles.<br>Pronto habrá nuevos torneos disponibles.</div>
...
"""));
tc.put("packages/webclient/components/my_contests_comp.html", new HttpResponse(200, r"""<!-- LIVE CONTESTS -->
<section class="contest-list-section" id="live-contest-content"  ng-if="tabIsLive">
  ...
  <div ng-switch="hasLiveContests" class="contest-list-wrapper" ng-if="liveContestsInitialized">
    <!-- lista vacía -->
...
<section class="contest-list-section" id="waiting-contest-content" ng-if="tabIsWaiting">
  ...
  <div ng-switch="hasWaitingContests" class="contest-list-wrapper" ng-if="waitingContestsInitialized">
    <!-- lista vacía -->
    <div class="no-contests-wrapper" ng-switch-when="false">
        <img class="no-contests-icon" src="images/icon-torneo-proximo-vacio.png">
        <div class="no-contests-title" ng-if="numLiveContests > 0">No tienes ningún toreno pendiente de comenzar</div>
        <div class="no-contests-title" ng-if="numLiveContests == 0">No estás participando en ningún torneo</div>
        <div class="no-contests-subtitle" ng-if="numLiveContests > 0">Comprueba tus torneos en vivo</div>
        <div class="no-contests-subtitle" ng-if="numLiveContests == 0">Ve a la lista de torneos, elije uno y empieza a jugar</div>
        <button class="btn-go-to-contest" ng-click="emptyUpcomingAction()">{{getLocalizedText("tocontest")}}</button>
    </div>
    <!-- lista de concursos -->
    <div class="list-container" ng-switch-when="true">
...
<section class="contest-list-section" id="history-contest-content" ng-if="tabIsHistory">
  ...
  <div ng-switch="hasHistoryContests" class="contest-list-wrapper" ng-if="historyContestsInitialized">
    <!-- lista vacía -->
    <div class="no-contests-wrapper" ng-switch-when="false">
...
"""));
tc.put("packages/webclient/components/navigation/deprecated_version_screen_comp.html", new HttpResponse(200, r"""<div class="outdated-version-screen-wrapper" ng-if="show && updateType == 'outdated_version'">
  <div class="outdated-version-screen">
      <button class="button-blue" ng-click="goShop()"> 
        <i class="material-icons">system_update_alt</i>
        <span>Actualizar</span>
      </button>    
      <p >Nueva versión disponible</p>        
      <button class="button-gray" ng-click="delayVersion()">
        <i class="material-icons">update</i>
        <span>Más tarde</span>
      </button>
  </div>
</div>
<div class="deprecated-version-screen-wrapper" ng-if="show && updateType == 'deprecated_version'">
...
<div class="deprecated-version-screen-wrapper" ng-if="show && updateType == 'under_maintenance'">
  <div class="deprecated-version-screen">
    <img src="images/logoE11.png"></img>
    <h1>El servidor está en mantenimiento<br>Vuelve a intentarlo más tarde</h1>
    <!--p>{{getLocalizedText("body")}}</p-->
    <!--button ng-click="goShop()">{{getLocalizedText("button")}}</button--> 
  </div>
</div> 
...
<div class="flash-messages-container" ng-if="hasFlashMessages">
  <button class="flash-messages-clear" ng-click="clearFlashMessages()"><i class="material-icons">&#xE14C;</i></button>
  <div class="flash-message-alert" ng-repeat="msg in flashMessageList | limitTo: MAX_FLASH_MSG_SHOWN" ng-class="[msg.type]">
    {{msg.text}}
  </div>
</div>
...
<modal-window show-header="false" show-window="changeNameWindowShow" class="small first-nickname-change">
  ...
  <input class="first-nickname-input" type="text" maxlength="{{MAX_NICKNAME_LENGTH}}" ng-model="editedNickName" 
         placeholder="nombre de usuario" class="form-control" autocapitalize="off">
  <!-- Error de nickName -->
...
<!-- RIVALS SECTION -->
<section class="rivals-list-section" ng-if="isRivalsListInitialized" ng-show="isRivalsListActive">
  ...
  <div class="rivals-list-table-body">
    <div class="rivals-list-table-row" ng-repeat="rival in currentRivalList.elements" ng-class="{'current-user-row': isMainPlayer(rival['id'])}" ng-click="onUserClick(rival['id'])">
...
<section class="view-comparative-section" ng-if="isComparativeInitialized" ng-show="isComparativeActive">
...
<modal-window class="soccer-player-gameplays small" show-header="true" title="'Puntos de jugador'" show-window="isGameplaysModalOn">
  <div class="soccer-player-gameplays-name">
    <div class="gameplays-label">
      <div class="gameplays-soccer-name">{{gameplaysPlayer.name}}</div>
      <div class="gameplays-soccer-team">{{gameplaysPlayer.soccerTeam.name}}</div>
    </div>
